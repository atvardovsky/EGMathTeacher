...
| First-login profile, backend meeting-readiness scoring, active meeting reload restore, onboarding usage attribution, and student memory | `apps/api/src/student-profile`, `apps/web/src/App.tsx`, `.ai/project/use-cases.md`, `.ai/project/runtime-flows.md`, `.ai/project/data-model.md` |
